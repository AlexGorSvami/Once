...
# [] - любой из символов в скобках, диапазоны
# $ - конец строки
# ^ - начало строки
# \ - экранирование
# \d - любая цифра
...
# pattern1 = r'[А-Я]{2}\d{2}\d{2,3}'
# res_private = re.findall(pattern, text1)
# res_taxi = re.findall(pattern1, text1)
# print(res_private)
# print(res_taxi)

text3 = '''Он --- серо-буро-малиновая редиска!! 
>>>:-> 
А не кот. 
www.kot.ru'''

pattern = '(\w|[А-Яа-я]){0,}|-(\w|[А-Яа-я])'
words_list = re.findall(pattern, text3)
print(len(words_list))
print()
